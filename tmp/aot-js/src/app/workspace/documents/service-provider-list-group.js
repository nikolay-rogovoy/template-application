...
var ServiceProviderListGroup = (function (_super) {
    __extends(ServiceProviderListGroup, _super);
    function ServiceProviderListGroup(http) {
        return _super.call(this, http) || this;
    }
    /**Получить список*/
    ServiceProviderListGroup.prototype.getEntityGroupList = function (factory) {
        ...
        if (entityUrl == null) {
            ...
            return this.http.get(entityUrl)
                ...
                for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
                    var item = data_1[_i];
                    var newEntity = factory.createEmptyGroup();
    ...
    return ServiceProviderListGroup;
}(ServiceProviderList));
ServiceProviderListGroup = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [Http])
], ServiceProviderListGroup);
export { ServiceProviderListGroup };
//# sourceMappingURL=service-provider-list-group.js.map